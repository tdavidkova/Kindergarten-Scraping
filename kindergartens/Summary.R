...
doc <- doc %>% 
  ...
  body_add_par("Брой кандидати и места в кампания май 2019 (предв. данни)", style = "table title") %>%
  body_add_flextable(ft) %>% 
  body_add_par("", style = "heading 2") %>% 
  body_add_break()%>%
  body_add_par("Недостиг на места по райони", style = "heading 2") %>% 
...
# doc <- doc %>% 
#   body_add_par("Кампания детски градини и ясли 2019", style = "Normal") %>% 
#   body_add_par("Кампания детски градини и ясли 2019", style = "heading 1") %>% 
#   body_add_par("Кампания детски градини и ясли 2019", style = "heading 2") %>% 
#   body_add_par("Кампания детски градини и ясли 2019", style = "heading 3") %>% 
#   body_add_par("Кампания детски градини и ясли 2019", style = "centered") %>% 
#   body_add_par("Кампания детски градини и ясли 2019", style = "graphic title") %>% 
#   body_add_par("Кампания детски градини и ясли 2019", style = "table title") %>% 
#   body_add_par("Кампания детски градини и ясли 2019", style = "toc 1") %>% 
#   body_add_par("Кампания детски градини и ясли 2019", style = "toc 2") %>% 
#   body_add_par("Кампания детски градини и ясли 2019", style = "Balloon Text") 
#   